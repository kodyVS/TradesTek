  ...
  <v-row class="fill-height">
    <v-col>
      <v-autocomplete
        ...
        item-text="Name"
      ></v-autocomplete>
      <v-btn @click="getEvents()">go</v-btn>
      <v-sheet>
        <v-toolbar flat color="white">
          <v-btn color="primary" dark @click.stop="dialog = true"> New Time </v-btn>
        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent">
              ...
              <v-text-field v-model="descriptions" type="text" label="description"></v-text-field>
        ...
        >
          <v-card color="grey lighten-4" :width="350" flat>
            ...
            <v-card-text>
              ...
              <form v-else>
                <v-textarea
                  v-model="selectedEvent.descriptions"
                  type="text"
                  style="width: 100%"
                  :min-height="100"
...
export default {
  data: () => ({
    ...
    events: [
      {
        name: "test",
        start: "2020-09-29 10:01:00",
        end: "2020-09-29 10:02:00",
        color: "cyan",
      },
      {
        name: "test",
        start: "2020-09-29 10:06:00",
        end: "2020-09-29 10:07:00",
        color: "green",
      },
      {
        name: "test",
        start: "2020-09-28 08:00:00",
        end: "2020-09-28 08:15:00",
        color: "red",
      },
    ],
    dialog: false,
